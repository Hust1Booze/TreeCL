...
class GNNPolicy(torch.nn.Module):
    def __init__(self):
        ...
        self.final_mlp = torch.nn.Sequential( 
                            torch.nn.Linear(hidden_dim3, 1, bias=False),
                            torch.nn.Sigmoid()
                            )
    ...
    def forward(self, batch, inv=False, epsilon=0.01):
        ...
        try :
            ...
            graphroot = (batch.constraint_features_root,
        ...
        variable_avg1  = self.forward_graph(*graph0) #concatenation of averages variable/constraint features after conv 
        variable_avg2  = self.forward_graph(*graph1)
        variable_avgroot = self.forward_graph(*graphroot)

        return variable_avg1, variable_avg2, variable_avgroot
    ...
    def forward_graph(self, constraint_features, edge_indices, edge_features, 
        ...
        bbounds = None #self.bounds_embedding(bbounds)
